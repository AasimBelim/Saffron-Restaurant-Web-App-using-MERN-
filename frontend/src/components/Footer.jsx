    ...
    <div className="py-16">
      <footer className=" flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-black">
        <div className="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
          <a href="/" aria-label="Saffron — go to home page">
            <Logo variant="light" />
          </a>
          <div>
        ...
        <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
          <p className="max-w-60">
            Slow-cooked flavour, served fast. Order in minutes or reserve your
            table in seconds.
          </p>
          <div className="flex items-center gap-4 mt-3">
            {/* TODO: point these at Saffron's real social profiles */}
            <a href="#" aria-label="Saffron on Dribbble">
              <svg
            ...
            <a href="#" aria-label="Saffron on LinkedIn">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
            ...
            <a href="#" aria-label="Saffron on X">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
            ...
            <a href="#" aria-label="Saffron on YouTube">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
